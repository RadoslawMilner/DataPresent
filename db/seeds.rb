...
individual_sports = %w[tennis parachuting badminton archery chess boxing racing golf running skiing walking cycling surfing swimming]

individual_sports.each do |c|
